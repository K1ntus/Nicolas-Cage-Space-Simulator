...
/**
 * This class is meant to define a new Object Planet, which is not instanciable
 * due to the toString abstract method. Planet is an Abstract class of the
 * general type "planet".
 * 
 * Planets are defined by a user, and they all have a different produce rate.
 * Each planets can be selected, and own a number of troops with a specific ship
 * type.
 * 
 * @see RoundPlanet
 * @see SquarePlanet
...
public abstract class Planet extends Sprite {
	...
	/**
	 * check new position for Constants
	 * 
