...
public final class Constants {
	 ...
	 */
	public static int nb_planets_tentatives = 10; // <-> max planets available //Exponential complexity | Usually 10 is
													// ok
	...
	/**
	 * Enable some print to be done to check informations Enabling it display the
	 * time used for each game board initialization Display which planet you have
	 * selected, ...
	 */
	...
	/**
	 * String message to send when the player lost the current game Put as constant
	 * to be easily changed for langage
	 */
	public static final String message_game_over = "You Lose !";

	/**
	 * String message to send when the player win the current game Put as constant
	 * to be easily changed for langage
	 */
	...
	/* Event */
	/**
	 * The troops decrementing value when a planet got the sickness event
	 */
