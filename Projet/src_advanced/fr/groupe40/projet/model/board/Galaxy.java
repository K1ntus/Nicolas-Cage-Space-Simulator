...
public class Galaxy implements Serializable {
    ...
    /**
     * Reset every constant user has not lose
     * Also reset the id counter for ai
     */
	 ...
	 * 
	 * @param direction The scroll action (up or down case)
	 */
	 ...
	 * @return the list of squads of the game
	 */
	 ...
	 * 
	 * @return the list of planets of the game
	 */
